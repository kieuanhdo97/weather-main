...
public class DaysAdapter extends RecyclerView.Adapter<DaysAdapter.DayViewHolder> {
    ...
    private String updated_at, date_at, min, max, pressure, wind_speed, humidity;
    ...
    private void getDailyWeatherInfo(int i, DayViewHolder holder) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url.getLink(), null, response -> {
            try {
                ...
                date_at = new SimpleDateFormat("dd/MM", Locale.ENGLISH).format(new Date((update_time * 1000) + (i * 864_000_00L)));   // i=0
    ...
    private void updateUI(DayViewHolder holder) {
        ...
        String date = UpdateUI.TranslateDay(date_at, context);
    ...
    static class DayViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView dTime,date, temp_min, temp_max, pressure, wind, humidity;
        ImageView icon;
